...
$tpl->assign(array('rcheck' => $rcheck, 'grouparr' => $grouparr));
if ($rcheck === true)
{
	$tpl->assign(array('subject' => $_GET['subject'], 'retention' => $_GET['retention'], 'group' => $_GET['group'], 'filearr' => $farr, 'nzb_img' => '<img src="raintemplates/images/nzb.png" alt="nzb" width="20" height="25">'));
