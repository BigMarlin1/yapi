<?php if(!class_exists('raintpl')){exit;}?><table class="data" border="1">
	...
	<tr class="row_<?php echo $counter1%2+1;?>">
		<td class="subject">
			<a class="subject" style="text-decoration: none;" href="browsenzb.php?chash=<?php echo $value1["chash"];?>&group=<?php echo $value1["groupid"];?>&subject=<?php echo urlencode( $value1["subject"] );?>"><?php echo $value1["subject"];?></a>
